...
export default function HoverableCard({
  ...
  return (
    <Pressable
      ...
      onPressIn={!isWeb ? () => setIsHovered(true) : undefined}
      onPressOut={!isWeb ? () => setIsHovered(false) : undefined}
      style={[styles.card, isHovered && styles.cardHovered]}
    >
      <View ref={innerRef} style={[styles.cardInner, isHovered && styles.cardInnerHovered]}>
        {/* Multiple thickness layers for 3D effect */}
        <View style={[styles.cardSide1, isHovered && styles.cardSideHovered]} />
        <View style={[styles.cardSide2, isHovered && styles.cardSideHovered]} />
        <View style={[styles.cardSide3, isHovered && styles.cardSideHovered]} />
        ...
        <View style={styles.cardFront}>
          ...
          <View style={styles.imageContainer}>
            ...
            {/* Glow effect */}
            <View style={[styles.glow, isHovered && styles.glowActive]} />
          </View>
...
const styles = StyleSheet.create({
  ...
  hoverOverlay: {
    ...
    zIndex: 20,
    // @ts-ignore
    animation: Platform.OS === 'web' ? 'slideUp 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)' : undefined,
  },
  overlayContent: {
    flexDirection: 'row',
    alignItems: 'center',
